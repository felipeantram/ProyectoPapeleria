...
INSERT INTO `administrador` (`idAdmin`, `nombreCompleto`, `correo`, `password`, `direccion`, `codigoAdmin`) VALUES
	(1, 'Felipe de Jesus Antonio Ramirez', 'antram@gmail.com', 'admin1953', 'Calle 10 #123', 'AD001');
...
INSERT INTO `cliente` (`idCliente`, `nombreCompleto`, `correo`, `password`, `telefono`, `idDomicilio`) VALUES
	(1, 'Rodrigo Santiago Revilla', 'RodrigoSantiago@gmail.com', '12345', '9511940689', NULL);
...
INSERT INTO `empleado` (`idEmp`, `nombreCompleto`, `correo`, `contraseña`, `direccion`, `sueldo`, `idDomicilio`) VALUES
	(1, 'Diana Laura Santiago Hernandez', 'diaherza@gmail.com', 'empl4396', 'Av. Reforma 45', 8500.00, NULL);
